...
[![dependencies](https://img.shields.io/badge/dependencies-optional-brightgreen)](https://img.shields.io/badge/dependencies-optional-brightgreen)
...
**Multi-radix binary-to-text codec. One optional dependency. Production-hardened.**
...
$ echo "^b81:7:standard^18EQ4f5^^" | base81 decode --header --ignore-ws
Hello
```
